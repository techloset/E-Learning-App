...
const Explore = () => {
  return (
    <div className='bg-gradient-to-r from-blue-100 via-blue-100 to-white bg-blue-100 bg-opacity-75'>
        <br /><br /><br /><br />
        <br /><br /><br /><br />

    <div className=' h-full mx-4 sm:mx-10 lg:mx-16 '>
      <h1 className='font-bold text-4xl'>Explore Courses</h1>
      <br />
      <p className='text-gray-600'>Ut sed eros finibus, placerat orci id, dapibus.</p>
      <br /> <br /> 


{/* start of the lorem ipsum in the explore courses */}
...
<div class="flex flex-col sm:flex-row justify-between  -mt-28   sm:w-[500px]  mx-10 p-6 bg-white border-4 border-[#347a83a7] rounded-3xl shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    ...
    <div>
        <br />
      <h5 class=" text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Integer id Orc Sed <br /> Ante Tincidunt </h5>
      <p class="font-normal text-gray-700 dark:text-gray-400">Cras convallis lacus orci, <br /> tristuque tincidunt magna <br /> fringilla at faucibus vel. </p>
      ...
      <button className='border-[#00BCD4] text-[#00BCD4] font-semibold text-xl border-2  w-full py-2 rounded-xl'>Explore</button>
    </div>
    </div>
  </div>
...
<br /><br />
<div className='flex justify-between'>
       <p className='flex text-2xl font-bold'> <svg xmlns="http://www.w3.org/2000/svg" className='  mt-2 w-5 h-6 mr-3' viewBox="0 0 24 24"><path d="M23.92,11.24a12.33,12.33,0,0,0-9-10.37,9.82,9.82,0,0,0-5.78,0A12.47,12.47,0,0,0,.36,9.75,11.88,11.88,0,0,0,3.52,21.13a2.5,2.5,0,0,0,3.08.36,1.5,1.5,0,0,0,.26-2.33l-.81-.81a1,1,0,0,1,0-1.42,1.1,1.1,0,0,1,1.6-.19c1.41,1.41,5.62,5.66,5.62,5.66a4,4,0,0,0,2.82,1.18A3.68,3.68,0,0,0,18,23.05,12,12,0,0,0,23.92,11.24Zm-9.44,7.62a2.49,2.49,0,0,1,0-3.53,2.54,2.54,0,0,1,3.53,0,2.5,2.5,0,0,1-3.53,3.53ZM14.25,7.2a2,2,0,0,1,2-2h0a2,2,0,1,1-2,2Zm3.69,6h0a1.5,1.5,0,0,1,2.12-2.12,1.5,1.5,0,1,1-2.12,2.12ZM11.65,4.72a2,2,0,1,1-2.83,0A2,2,0,0,1,11.65,4.72Z" fill="#000000"></path></svg> Quisqu Consquat</p>
        <p className='text-[#00BCD4] text-2xl font-bold'>SEE ALL →</p>
      </div>
      ...
      {/* =============================================2nd part================================== */}
<div className=' grid xl:grid-cols-2 2xl:grid-cols-3 gap-2 justify-between'>
...
{/* end of the second explore course */}

<div className='flex justify-between mt-72 sm:mt-0 md:mt-36'>
       <p className='flex text-2xl font-bold'> <svg xmlns="http://www.w3.org/2000/svg" className='  mt-2 w-5 h-6 mr-3' viewBox="0 0 24 24"><path d="M23.92,11.24a12.33,12.33,0,0,0-9-10.37,9.82,9.82,0,0,0-5.78,0A12.47,12.47,0,0,0,.36,9.75,11.88,11.88,0,0,0,3.52,21.13a2.5,2.5,0,0,0,3.08.36,1.5,1.5,0,0,0,.26-2.33l-.81-.81a1,1,0,0,1,0-1.42,1.1,1.1,0,0,1,1.6-.19c1.41,1.41,5.62,5.66,5.62,5.66a4,4,0,0,0,2.82,1.18A3.68,3.68,0,0,0,18,23.05,12,12,0,0,0,23.92,11.24Zm-9.44,7.62a2.49,2.49,0,0,1,0-3.53,2.54,2.54,0,0,1,3.53,0,2.5,2.5,0,0,1-3.53,3.53ZM14.25,7.2a2,2,0,0,1,2-2h0a2,2,0,1,1-2,2Zm3.69,6h0a1.5,1.5,0,0,1,2.12-2.12,1.5,1.5,0,1,1-2.12,2.12ZM11.65,4.72a2,2,0,1,1-2.83,0A2,2,0,0,1,11.65,4.72Z" fill="#000000"></path></svg>Aenean Facilisis</p>
        <p className='text-[#00BCD4] text-2xl font-bold'>SEE ALL →</p>
</div>

<div className='hidden sm:block'><br /> <br /> <br /> <br /> <br /> <br /> <br />  </div>
      <div>
...
<div className="flex flex-col sm:flex-row justify-between  -mt-28 sm:w-[500px] 2xl:w-[105%]  mx-10 p-6 bg-white border-4 border-[#347a83a7] rounded-3xl shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    ...
    <div>
        <br />
      <h5 className=" text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Integer id Orc Sed <br /> Ante Tincidunt </h5>
      <p className="font-normal text-gray-700 dark:text-gray-400">Cras convallis lacus orci, <br /> tristuque tincidunt magna <br /> fringilla at faucibus vel. </p>
      <div className='flex justify-between mt-4'>

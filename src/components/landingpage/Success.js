      ...
      <br /><br /><br /><br />
        <div className='sm:mx-16 mx-10 '>
            ...
            <div className='flex flex-col sm:flex-row justify-between text-center '>
                <div className='xl:text-8xl md:text-3xl text-2xl lg:text-5xl flex flex-col text-[#136CB5] '>
   ...
   <div className='grid lg:grid-cols-2 gap-16 '>
    <div className="flex items-center w-full  justify-center">
        ...
        <div className='absolute'>
           <h2 className="text-2xl text-white font-bold mb-2 ">FOR INSTRUCTORS</h2><br />
    ...
    <div className="flex items-center w-full  justify-center">
        ...
        <div className='absolute'>
           <h2 className="text-2xl text-white font-bold mb-2 ">FOR STUDENTS</h2><br />
...
<div className='grid lg:grid-cols-2 xl:gap-12 gap-6  '>        
    ...
    <h1 className='text-[#2F327D] text-2xl xl:text-4xl font-semibold '>A <span className='text-[#00CBB8]'>user interface </span>designed for the classroom</h1><br />
  ...
  <rect x="14.7734" y="14.1819" width="11.8182" height="11.8182" rx="2" fill="#F48C06"/>
          ...
          <p className=' text-lg ml-3'>Teachers don’t get lost in the grid view and have a dedicated Podium space.</p>
        </div><br />
...
<h1 className='text-[#2F327D] text-2xl xl:text-4xl font-bold  mt-4 sm:w-2/3'><span className='text-[#00CBB8]'>Tools</span> For Teachers And Learners</h1><br /><br />
    
<p className=' text-xl'>Class has a dynamic set of teaching tools built to be deployed and used during class.
...
<h1 className='text-[#2F327D] text-3xl xl:text-4xl font-bold  w-2/3 xl:w-1/2'>Assessments,  <span className='text-[#00CBB8]'>Quizzes</span>, Tests </h1><br /><br />
    
<p className=' xl:w-3/4'>Easily launch live assignments, quizzes, and tests.
...
<h1 className='text-[#2F327D] text-3xl xl:text-4xl font-bold  mt-4 xl:w-2/3'>Class Management <span className='text-[#00CBB8]'>Tools for Educators </span> </h1><br /><br />
    
<p className='sm:w-3/4'>Class provides tools to help run and manage the class such as Class Roster, Attendance, and more. With the Gradebook, teachers can review and grade tests and quizzes in real-time.
</p>
...
<div className='grid lg:grid-cols-2 '> 
 ...
 <h1 className='text-[#2F327D] text-3xl xl:text-4xl md:w-2/3 font-bold  mt-4 xl:w-1/2'>One-on-One   <span className='text-[#00CBB8]'>Discussion</span></h1><br /><br />
     
 <p className='lg:w-2/3  '>Teachers and teacher assistants can talk with students privately without leaving the Zoom environment.</p>

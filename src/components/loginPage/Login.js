...
const Login = () => {
  ...
  return (
    <div className='flex  xl:flex-row  flex-col '>
        ...
        <div className=' justify-center px-5  mx-auto xl:mx-10  lg:px-0 w-[454px]   2xl:mx-auto mb-36 lg:mb-16' > 
            ...
            <p className='mt-12 text-lg text-[#5B5B5B] float-left'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            <label className='float-left text-lg mb-6 mt-10'>User name</label>
             <input

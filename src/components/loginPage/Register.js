...
const Register = () => {
  ...
  return (
    ...
    <div className=' text-white hidden lg:block py-[38px] pl-[38px] mx-auto  '>
    ...
    <div className=' justify-center px-5 w-[454px]  mx-auto mb-[103px] lg:mb-16' > 
        ...
        <label className='float-left text-lg  mb-6'>Email Adress</label>
        <br /><br />
      ...
      >
        ...
        <div className="flex items-center justify-between">
            ...
            <br /><br />
            <button className='float-right text-xl text-white rounded-full bg-[#49BBBD] px-24 py-3 '>Register</button>
            <div>

...
const SmallCard =()=>{
    return(
        ...
        <h1 className='text-2xl font-semibold '>O6 Super Coins On the way</h1>
        {/* [#] */}
        <div className=''>
        <button
className="mb-2 inline-block bg-[#49BBBD] rounded-full xl:p-3 p-2 mx-1 xl:mx-3 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
>
<svg
...
export default CourseCalender2
